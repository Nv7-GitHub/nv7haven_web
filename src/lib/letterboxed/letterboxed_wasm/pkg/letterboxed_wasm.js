...
* @returns {Array<any>}
*/
export function solve(allowed, words) {
    const ret = wasm.solve(addHeapObject(allowed), addHeapObject(words));
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('letterboxed_wasm_bg.wasm', import.meta.url);
    }
    const imports = getImports();
